        ...
        <div className="bg-white/80 backdrop-blur-md shadow-lg border-b-4 border-red-500">
          <div className="max-w-4xl mx-auto px-6 py-8 text-center">
            ...
            <p className="text-gray-600 text-lg">
              {user ? `Welcome back, ${user.username}! This is your personalized health feed` : 'This is your home feed'}
            </p>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto px-4 py-8">
          ...
          {showForm && (
            <div className="bg-white/90 backdrop-blur-md border-2 border-red-200 rounded-2xl p-6 shadow-xl mb-6">
              <h3 className="text-2xl font-bold text-red-600 mb-6">Share Your Thoughts</h3>
              ...
              <div className="mb-4">
                <label className="block text-gray-700 font-medium mb-2">Group (optional)</label>
                <select
                  value={newPost.group}
